...
KV_CAPABILITY_JOBS_DB_INDEX = int(
    os.getenv("KV_CAPABILITY_JOBS_DB_INDEX", KV_JOB_DB_INDEX)
)
FAAS_CAPABILITY_TOKEN = os.getenv("FAAS_CAPABILITY_TOKEN", SECRET_KEY)
FAAS_CAPABILITY_INDEXER_URL = os.getenv("FAAS_CAPABILITY_INDEXER_URL")
FAAS_CAPABILITY_PLAYLIST_BUILD_URL = os.getenv(
    "FAAS_CAPABILITY_PLAYLIST_BUILD_URL"
)
FAAS_CAPABILITY_VIDEO_PROCESSING_URL = os.getenv(
    "FAAS_CAPABILITY_VIDEO_PROCESSING_URL"
)
FAAS_CAPABILITY_TRIGGER_TIMEOUT = float(
    os.getenv("FAAS_CAPABILITY_TRIGGER_TIMEOUT", "3")
)
FAAS_CAPABILITY_TRIGGER_BATCH_SIZE = int(
    os.getenv("FAAS_CAPABILITY_TRIGGER_BATCH_SIZE", "20")
)
